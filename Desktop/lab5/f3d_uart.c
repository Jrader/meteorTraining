 ...
 * These definitions set up the main function.
 *
 * Author: Joey Rader -jcrader Di Zhong -dizhong
 ...
 *f3d_uart.c contains the put char and put string function that allows us to pass letters and phrases through the uart. 
****************************/ 
